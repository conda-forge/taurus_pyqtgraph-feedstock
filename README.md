...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/taurus_pyqtgraph-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/taurus_pyqtgraph-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add taurus_pyqtgraph
# for installing globally
pixi global install taurus_pyqtgraph
```
...
It is possible to list all of the versions of `taurus_pyqtgraph` available on your platform:
...
```
pixi search taurus_pyqtgraph --channel conda-forge
```
